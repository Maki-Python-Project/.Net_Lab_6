        ...
        public static IHasName Couple(Human human, Human human1)
        {
            ...
            foreach (CoupleAttribute attribute in human)
            {
                if (attribute.Pair == human1.GetType().Name)
                {
                    ...
                    {
                        human1Like = true;
                        Console.WriteLine(human1.GetType().GetProperty("Name").GetValue(human1) + " to love " + human.GetType().GetProperty("Name").GetValue(human));
                        break;
                    }
                    else
                    {
                        Console.WriteLine(human1.GetType().GetProperty("Name").GetValue(human1) + " not to love " + human.GetType().GetProperty("Name").GetValue(human));
                    }
                }
            }
            ...
            foreach (CoupleAttribute attribute in human1)
            {
                if (attribute.Pair == human.GetType().Name)
                {
                    ...
                    {
                        human2Like = true;
                        Console.WriteLine(human.GetType().GetProperty("Name").GetValue(human) + " to love " + human1.GetType().GetProperty("Name").GetValue(human1));
                        break;
                    }
                    else
                    {
                        Console.WriteLine(human.GetType().GetProperty("Name").GetValue(human) + " not to love " + human1.GetType().GetProperty("Name").GetValue(human1));
                    }
                }
            }
            ...
            if (human2Like && human1Like)
            {
                ...
                if (type != null)
                {
                    ...
                    if (nameProperty != null && lastnameProperty != null)
                    {
                        ...
                        {
                            lastnameProperty.SetValue(child, lastnameProperty.GetValue(child) + "iвна");
                        }
                    }
                }
